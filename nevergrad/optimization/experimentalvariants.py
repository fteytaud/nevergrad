...
# SimpleSA
# llambda = [8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 128]
# mu = [l // 2 for l in llambda]
# chaine = []
# for l in llambda:
#     for m in mu:
#         if m < l:
#             tmp = f"NaiveSimpleSA_{m}_{l}"
#             print(f"{tmp} = SimpleSA(mu={m}, llambda={l}).set_name(\"{tmp}\", register=True)")

NaiveSimpleSA_4_8 = SimpleSA(mu=4, llambda=8).set_name("NaiveSimpleSA_4_8", register=True)
...
NaiveSimpleSA_12_16 = SimpleSA(mu=12, llambda=16).set_name("NaiveSimpleSA_12_16", register=True)
NaiveSimpleSA_4_24 = SimpleSA(mu=4, llambda=24).set_name("NaiveSimpleSA_4_24", register=True)
NaiveSimpleSA_8_24 = SimpleSA(mu=8, llambda=24).set_name("NaiveSimpleSA_8_24", register=True)
NaiveSimpleSA_12_24 = SimpleSA(mu=12, llambda=24).set_name("NaiveSimpleSA_12_24", register=True)
NaiveSimpleSA_16_24 = SimpleSA(mu=16, llambda=24).set_name("NaiveSimpleSA_16_24", register=True)
NaiveSimpleSA_20_24 = SimpleSA(mu=20, llambda=24).set_name("NaiveSimpleSA_20_24", register=True)
...
NaiveSimpleSA_12_32 = SimpleSA(mu=12, llambda=32).set_name("NaiveSimpleSA_12_32", register=True)
NaiveSimpleSA_16_32 = SimpleSA(mu=16, llambda=32).set_name("NaiveSimpleSA_16_32", register=True)
NaiveSimpleSA_20_32 = SimpleSA(mu=20, llambda=32).set_name("NaiveSimpleSA_20_32", register=True)
NaiveSimpleSA_24_32 = SimpleSA(mu=24, llambda=32).set_name("NaiveSimpleSA_24_32", register=True)
NaiveSimpleSA_28_32 = SimpleSA(mu=28, llambda=32).set_name("NaiveSimpleSA_28_32", register=True)
NaiveSimpleSA_4_40 = SimpleSA(mu=4, llambda=40).set_name("NaiveSimpleSA_4_40", register=True)
NaiveSimpleSA_8_40 = SimpleSA(mu=8, llambda=40).set_name("NaiveSimpleSA_8_40", register=True)
NaiveSimpleSA_12_40 = SimpleSA(mu=12, llambda=40).set_name("NaiveSimpleSA_12_40", register=True)
NaiveSimpleSA_16_40 = SimpleSA(mu=16, llambda=40).set_name("NaiveSimpleSA_16_40", register=True)
NaiveSimpleSA_20_40 = SimpleSA(mu=20, llambda=40).set_name("NaiveSimpleSA_20_40", register=True)
NaiveSimpleSA_24_40 = SimpleSA(mu=24, llambda=40).set_name("NaiveSimpleSA_24_40", register=True)
NaiveSimpleSA_28_40 = SimpleSA(mu=28, llambda=40).set_name("NaiveSimpleSA_28_40", register=True)
NaiveSimpleSA_32_40 = SimpleSA(mu=32, llambda=40).set_name("NaiveSimpleSA_32_40", register=True)
NaiveSimpleSA_4_48 = SimpleSA(mu=4, llambda=48).set_name("NaiveSimpleSA_4_48", register=True)
NaiveSimpleSA_8_48 = SimpleSA(mu=8, llambda=48).set_name("NaiveSimpleSA_8_48", register=True)
NaiveSimpleSA_12_48 = SimpleSA(mu=12, llambda=48).set_name("NaiveSimpleSA_12_48", register=True)
NaiveSimpleSA_16_48 = SimpleSA(mu=16, llambda=48).set_name("NaiveSimpleSA_16_48", register=True)
NaiveSimpleSA_20_48 = SimpleSA(mu=20, llambda=48).set_name("NaiveSimpleSA_20_48", register=True)
NaiveSimpleSA_24_48 = SimpleSA(mu=24, llambda=48).set_name("NaiveSimpleSA_24_48", register=True)
NaiveSimpleSA_28_48 = SimpleSA(mu=28, llambda=48).set_name("NaiveSimpleSA_28_48", register=True)
NaiveSimpleSA_32_48 = SimpleSA(mu=32, llambda=48).set_name("NaiveSimpleSA_32_48", register=True)
NaiveSimpleSA_40_48 = SimpleSA(mu=40, llambda=48).set_name("NaiveSimpleSA_40_48", register=True)
NaiveSimpleSA_4_56 = SimpleSA(mu=4, llambda=56).set_name("NaiveSimpleSA_4_56", register=True)
NaiveSimpleSA_8_56 = SimpleSA(mu=8, llambda=56).set_name("NaiveSimpleSA_8_56", register=True)
NaiveSimpleSA_12_56 = SimpleSA(mu=12, llambda=56).set_name("NaiveSimpleSA_12_56", register=True)
NaiveSimpleSA_16_56 = SimpleSA(mu=16, llambda=56).set_name("NaiveSimpleSA_16_56", register=True)
NaiveSimpleSA_20_56 = SimpleSA(mu=20, llambda=56).set_name("NaiveSimpleSA_20_56", register=True)
NaiveSimpleSA_24_56 = SimpleSA(mu=24, llambda=56).set_name("NaiveSimpleSA_24_56", register=True)
NaiveSimpleSA_28_56 = SimpleSA(mu=28, llambda=56).set_name("NaiveSimpleSA_28_56", register=True)
NaiveSimpleSA_32_56 = SimpleSA(mu=32, llambda=56).set_name("NaiveSimpleSA_32_56", register=True)
NaiveSimpleSA_40_56 = SimpleSA(mu=40, llambda=56).set_name("NaiveSimpleSA_40_56", register=True)
NaiveSimpleSA_48_56 = SimpleSA(mu=48, llambda=56).set_name("NaiveSimpleSA_48_56", register=True)
...
NaiveSimpleSA_12_64 = SimpleSA(mu=12, llambda=64).set_name("NaiveSimpleSA_12_64", register=True)
NaiveSimpleSA_16_64 = SimpleSA(mu=16, llambda=64).set_name("NaiveSimpleSA_16_64", register=True)
NaiveSimpleSA_20_64 = SimpleSA(mu=20, llambda=64).set_name("NaiveSimpleSA_20_64", register=True)
NaiveSimpleSA_24_64 = SimpleSA(mu=24, llambda=64).set_name("NaiveSimpleSA_24_64", register=True)
NaiveSimpleSA_28_64 = SimpleSA(mu=28, llambda=64).set_name("NaiveSimpleSA_28_64", register=True)
NaiveSimpleSA_32_64 = SimpleSA(mu=32, llambda=64).set_name("NaiveSimpleSA_32_64", register=True)
NaiveSimpleSA_40_64 = SimpleSA(mu=40, llambda=64).set_name("NaiveSimpleSA_40_64", register=True)
NaiveSimpleSA_48_64 = SimpleSA(mu=48, llambda=64).set_name("NaiveSimpleSA_48_64", register=True)
NaiveSimpleSA_4_80 = SimpleSA(mu=4, llambda=80).set_name("NaiveSimpleSA_4_80", register=True)
NaiveSimpleSA_8_80 = SimpleSA(mu=8, llambda=80).set_name("NaiveSimpleSA_8_80", register=True)
NaiveSimpleSA_12_80 = SimpleSA(mu=12, llambda=80).set_name("NaiveSimpleSA_12_80", register=True)
NaiveSimpleSA_16_80 = SimpleSA(mu=16, llambda=80).set_name("NaiveSimpleSA_16_80", register=True)
NaiveSimpleSA_20_80 = SimpleSA(mu=20, llambda=80).set_name("NaiveSimpleSA_20_80", register=True)
NaiveSimpleSA_24_80 = SimpleSA(mu=24, llambda=80).set_name("NaiveSimpleSA_24_80", register=True)
NaiveSimpleSA_28_80 = SimpleSA(mu=28, llambda=80).set_name("NaiveSimpleSA_28_80", register=True)
NaiveSimpleSA_32_80 = SimpleSA(mu=32, llambda=80).set_name("NaiveSimpleSA_32_80", register=True)
NaiveSimpleSA_40_80 = SimpleSA(mu=40, llambda=80).set_name("NaiveSimpleSA_40_80", register=True)
NaiveSimpleSA_48_80 = SimpleSA(mu=48, llambda=80).set_name("NaiveSimpleSA_48_80", register=True)
NaiveSimpleSA_64_80 = SimpleSA(mu=64, llambda=80).set_name("NaiveSimpleSA_64_80", register=True)
NaiveSimpleSA_4_96 = SimpleSA(mu=4, llambda=96).set_name("NaiveSimpleSA_4_96", register=True)
NaiveSimpleSA_8_96 = SimpleSA(mu=8, llambda=96).set_name("NaiveSimpleSA_8_96", register=True)
NaiveSimpleSA_12_96 = SimpleSA(mu=12, llambda=96).set_name("NaiveSimpleSA_12_96", register=True)
NaiveSimpleSA_16_96 = SimpleSA(mu=16, llambda=96).set_name("NaiveSimpleSA_16_96", register=True)
NaiveSimpleSA_20_96 = SimpleSA(mu=20, llambda=96).set_name("NaiveSimpleSA_20_96", register=True)
NaiveSimpleSA_24_96 = SimpleSA(mu=24, llambda=96).set_name("NaiveSimpleSA_24_96", register=True)
NaiveSimpleSA_28_96 = SimpleSA(mu=28, llambda=96).set_name("NaiveSimpleSA_28_96", register=True)
NaiveSimpleSA_32_96 = SimpleSA(mu=32, llambda=96).set_name("NaiveSimpleSA_32_96", register=True)
NaiveSimpleSA_40_96 = SimpleSA(mu=40, llambda=96).set_name("NaiveSimpleSA_40_96", register=True)
NaiveSimpleSA_48_96 = SimpleSA(mu=48, llambda=96).set_name("NaiveSimpleSA_48_96", register=True)
NaiveSimpleSA_64_96 = SimpleSA(mu=64, llambda=96).set_name("NaiveSimpleSA_64_96", register=True)
...
NaiveSimpleSA_12_128 = SimpleSA(mu=12, llambda=128).set_name("NaiveSimpleSA_12_128", register=True)
NaiveSimpleSA_16_128 = SimpleSA(mu=16, llambda=128).set_name("NaiveSimpleSA_16_128", register=True)
NaiveSimpleSA_20_128 = SimpleSA(mu=20, llambda=128).set_name("NaiveSimpleSA_20_128", register=True)
NaiveSimpleSA_24_128 = SimpleSA(mu=24, llambda=128).set_name("NaiveSimpleSA_24_128", register=True)
NaiveSimpleSA_28_128 = SimpleSA(mu=28, llambda=128).set_name("NaiveSimpleSA_28_128", register=True)
NaiveSimpleSA_32_128 = SimpleSA(mu=32, llambda=128).set_name("NaiveSimpleSA_32_128", register=True)
NaiveSimpleSA_40_128 = SimpleSA(mu=40, llambda=128).set_name("NaiveSimpleSA_40_128", register=True)
NaiveSimpleSA_48_128 = SimpleSA(mu=48, llambda=128).set_name("NaiveSimpleSA_48_128", register=True)
NaiveSimpleSA_64_128 = SimpleSA(mu=64, llambda=128).set_name("NaiveSimpleSA_64_128", register=True)
