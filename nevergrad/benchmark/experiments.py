...
def deceptive(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    seedg = create_seed_generator(seed)
    names = ["deceptivemultimodal", "deceptiveillcond", "deceptivepath"]
    optims = ["FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO", "PSO", "MiniQrDE", "MiniLhsDE", "MiniDE", "CMA", "QrDE", "DE", "LhsDE"]
    functions = [
        ArtificialFunction(name, block_dimension=2, num_blocks=n_blocks, rotation=rotation, aggregator=aggregator)
        for name in names
        for rotation in [False, True]
...
def yabbob(seed: Optional[int] = None, parallel: bool = False, big: bool = False, noise: bool = False, hd: bool = False) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["NaiveTBPSA", "TBPSA", "FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO", "CMA", "PSO", "DE", "MiniDE", "QrDE", "MiniQrDE", "LhsDE", "OnePlusOne",
              "TwoPointsDE", "OnePointDE", "AlmostRotationInvariantDE", "RotationInvariantDE"]
    if not parallel:
...
def illcondi(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO", "CMA", "PSO", "DE", "MiniDE", "QrDE", "MiniQrDE", "LhsDE", "OnePlusOne", "SQP", "Cobyla",
...
def illcondipara(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO", "CMA", "PSO", "DE", "MiniDE", "QrDE", "MiniQrDE", "LhsDE", "OnePlusOne",
              "TwoPointsDE", "OnePointDE", "AlmostRotationInvariantDE", "RotationInvariantDE",
              "Portfolio", "ASCMADEthird", "ASCMADEQRthird", "ASCMA2PDEthird", "CMandAS2", "CMandAS", "CM",
...
def constrained_illconditioned_parallel(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    """
    seedg = create_seed_generator(seed)
    optims = ["FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO", "CMA", "PSO", "DE", "MiniDE", "QrDE", "MiniQrDE", "LhsDE", "OnePlusOne", "SQP", "Cobyla", "Powell",
              "TwoPointsDE", "OnePointDE", "AlmostRotationInvariantDE", "RotationInvariantDE",
              "Portfolio", "ASCMADEthird", "ASCMADEQRthird", "ASCMA2PDEthird", "CMandAS2", "CMandAS", "CM",
              "MultiCMA", "TripleCMA", "MultiScaleCMA", "RSQP", "RCobyla", "RPowell", "SQPCMA"]
    functions = [
...
def fastgames(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    algos = ["NaiveTBPSA", "ScrHammersleySearch", "PSO", "OnePlusOne",
             ...
             "RandomScaleRandomSearch", "MiniDE", "SplitOptimizer5", "FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO"]
...
def mldaas(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    funcs += [_mlda.Landscape(transform) for transform in [None, "square", "gaussian"]]
    seedg = create_seed_generator(seed)
    algos = ["NaiveTBPSA", "ScrHammersleySearch", "PSO", "OnePlusOne", "FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO", "CMA", "OnePointDE", "TwoPointsDE", "QrDE", "LhsDE",
...
def double_o_seven(seed: Optional[int] = None) -> Iterator[Experiment]:
    ...
    for num_repetitions in [1, 10, 100]:
        for archi in ["mono", "multi"]:
            ...
            for optim in ["PSO", "FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO", "CMA", "DE", "TwoPointsDE", "TBPSA", "OnePlusOne", "Zero",
...
def multiobjective_example(seed: Optional[int] = None) -> Iterator[Experiment]:
    # prepare list of parameters to sweep for independent variables
    seedg = create_seed_generator(seed)
    optims = ["NaiveTBPSA", "PSO", "DE", "SQP", "LhsDE", "RandomSearch", "FT_EMNA_NGO", "FT_IEMNA_NGO", "FT_Fabienosaur_NGO", "FT_IFabienosaur_NGO", "NGO", "CMA", "BO", "LBO", "SQP", "RSQP"]
